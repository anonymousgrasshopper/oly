...
![Example using Neovim and oly](./assets/app/primitive_roots.png)
![Example using Neovim and oly](./assets/app/legendre_symbol.png)
![Example notes generated by oly gen](./assets/app/birkhoff-von_neumann.png)
![Example pdfs generated with oly and typst](./assets/app/tiling.png)
![Example using asymptote with oly](./assets/app/poncelet_porism.png)
